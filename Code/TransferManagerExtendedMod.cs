...
{
    public class TransferManagerExtendedMod : UserModBase
    {
        ...
        public static TransferManagerExtendedMod Instance
        {
            get
            {
                return (TransferManagerExtendedMod)BaseInstance;
            }
        }
        ...
        public override void OnLevelLoaded()
        {
            ...
            {
                m_modManagerGameObject = new GameObject("TransferManagerExtendedModManager");
