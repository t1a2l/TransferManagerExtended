...
namespace TransferManagerCore
{
    public class CustomTransferReason
    {
        ...
        public enum Reason
        {
            ...
            MealsDeliveryLow = 150,
            MealsDeliveryMedium = 151,
            MealsDeliveryHigh = 152,
            Anchovy = 153,
            Salmon = 154,
            Shellfish = 155,
            Tuna = 156,
            ...
            Sheep = 170,
            Pigs = 171,
            ProcessedVegetableOil = 172,
            LiquidConcentrates = 173,
            FishMeal = 174,
            FishOil = 175,
            ChemicalProducts = 176,
            Leather = 177,
            FoodProducts = 178,
            BeverageProducts = 179,
            BakedGoods = 180,
            CannedFish = 181,
            Furnitures = 182,
            ElectronicProducts = 183,
            IndustrialSteel = 184,
            Tupperware = 185,
            Toys = 186,
            PrintedProducts = 187,
